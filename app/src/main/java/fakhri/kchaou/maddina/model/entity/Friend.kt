 ...
 *************** if state equals follower, user can be show only posts create for followers and info of friend  ************
 *************** if state equals user, user can be show only name and job title of friend  ************/
data class Friend(val id :String? = null, var state : String? ="user")
